...
public class WhileOperationTest {
    ...
    public void printAllElements1() {
        Assertions.assertEquals("1 | 2 | 3 | ", WhileOperation.printAllElements(new int[]{1,2,3}));
    }

    @Test
    @DisplayName("printAllElements(); zero array")
    public void printAllElements2() {
        Assertions.assertEquals("", WhileOperation.printAllElements(new int[]{}));
    }
    ...
    public void printAllElements3() {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> {
            WhileOperation.printAllElements(arr1);
        });
    }
    ...
    public void printEverySecondElement1() {
        Assertions.assertEquals("2 | ", WhileOperation.printEverySecondElement(new int[]{1,2,3}));
    }

    @Test
    @DisplayName("printEverySecondElement(); zero array")
    public void printEverySecondElement2() {
        Assertions.assertEquals("", WhileOperation.printEverySecondElement(new int[]{}));
    }
    ...
    public void printEverySecondElement3() {
        int[] arr1 = null;
        Assertions.assertThrows(NullPointerException.class, () -> {
            WhileOperation.printEverySecondElement(arr1);
        });
    }
    ...
    public void printAllElementsReverse1() {
        Assertions.assertEquals("3 | 2 | 1 | ", WhileOperation.printAllElementsReverse(new int[]{1,2,3}));
    }

    @Test
    @DisplayName("printAllElementsReverse(); zero array")
    public void printAllElementsReverse2() {
        Assertions.assertEquals("", WhileOperation.printAllElementsReverse(new int[]{}));
    }
    ...
    public void printAllElementsReverse3() {
        int[] arr1 = null;
        Assertions.assertThrows(NullPointerException.class, () -> {
            WhileOperation.printAllElementsReverse(arr1);
        });
    }
}
