...
public class CalculatorWithMemoryDecoratorTest {
    private CalculatorWithMemoryDecorator calculator = new CalculatorWithMemoryDecorator(new CalculatorWithOperator());
    ...
    public void getCount() {
        ...
        calculator.save();
        Assertions.assertEquals(140.45999999999998, calculator.load());
    }
}
